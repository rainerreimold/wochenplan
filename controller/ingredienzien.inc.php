...
function doAction( $action = '', $id = '', $von=0, $lim=0, $order='asc' ) {
    ...
    if ( $action == '') {
       ...
       try {
               ...
               //   
		$sql = "SELECT Distinct `ingredienz_id`,`bezeichnung`,`beschreibung` FROM `ingredienz` where 1 order By `bezeichnung` asc";
		...
		if (DEBUG) echo "<br>".$sql."<br>";
		  ...
		  $ergebnis = $rueckgabe->fetchAll(PDO::FETCH_ASSOC);
	        ...
	        echo '<tr style="padding:8px;"><th colspan=3 style="font-family: Fira ;color:#ddd">Ingredienzen f&uuml;r Rezepte</th></tr>';
	        ...
	        foreach ($ergebnis as  $inhalt)
	        {
	            ...
	            echo "<a href=\"/details/$ingredienz_id\">".$inhalt['bezeichnung']."</a>";
				...
				echo "<a href=\"/details/$ingredienz_id\">".$inhalt['beschreibung']."</a>";
	            echo "<br></td></tr>";
	        }
