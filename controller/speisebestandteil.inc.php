...
/*********************************************************************************************************************
 ...
 Name: speisebestandteil.inc.php
 Typ: Controller
 Ziel: Das Erstellen einer Speise, erfolgt durch die Auswahl verschiedener Speiekomponenten. Diese werden so zu 
       ...
       Die Speisekbestandteile werden nicht direkt aufgerufen, sondern sind Teil der Speise. Mit der ID oder 
	   dem Hash der Speise, kann aus der Tabelle Seisebestandteil die jeweilig dazugehörende Speisekomponente 
	   ausgelesen werden.
